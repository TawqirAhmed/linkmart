							...
							<div class="row">
								<div class="content-product-left  col-sm-6 col-xs-12 ">
									<div id="thumb-slider-vertical" class="thumb-vertical-outer">
										...
										<ul class="thumb-vertical">
											...
											@foreach($product->variations as $key=>$vary)

											@if($key<3)
											<li class="owl2-item">
												<a data-index="0" class="img thumbnail" data-image="{{ asset('') }}uploads/products/{{ $product->name }}/{{ $vary->image }}" title="Canon EOS 5D">
													<img src="{{ asset('') }}uploads/products/{{ $product->name }}/{{ $vary->image }}" title="Canon EOS 5D" alt="Canon EOS 5D">
												</a>
											</li>
											@endif
									...
									<div class="large-image  vertical">
										<img itemprop="image" class="product-image-zoom" src="{{ asset('') }}uploads/products/{{ $product->name }}/{{ $product->image }}" data-zoom-image="uploads/products/{{ $product->name }}/{{ $product->image }}" title="{{ $product->name }}" alt="{{ $product->name }}">
									</div>
								...
								<div class="content-product-right col-sm-6 col-xs-12">
									...
									<div  class="product-label form-group">
										shop: <a class="" href="category.html" style="color:green;">Go To Super Store</a>
									</div>
					...
					<div class="bototm-detail">
						<div class="row">
							...
							<div class="col-lg-9 col-md-8  col-xs-12">
								...
								@php
									$products = App\Models\product::where('on_sale',1)->with('variations')->get();
								@endphp

								@include('web.home.slider.hotdeals')
