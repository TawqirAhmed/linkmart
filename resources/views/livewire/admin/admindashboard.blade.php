              ...
              <div class="card-body table-responsive p-0">
                ...
                <ul style="list-style-type:none;">
                  ...
                  @foreach ($latest_notice as $key=>$value)
                    ...
                    <a href="{{ route('admin.notice_details',$value->id) }}"><h5> <i class="fas fa-exclamation"></i> {{ $value->title }}</h5></a>
                  ...
                  <a href="{{ route('admin.notice_board') }}" class="btn btn-default">Go to Notice Board</a>
