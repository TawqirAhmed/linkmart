        ...
        <div class="col-lg-12 col-xs-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-3">
                            <h3 class="card-title">All Guidelines</h3>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-3">
                            <a class="btn btn-success float-right text-white" href="{{ route('admin.add_guideline') }}">Add New Guideline</a>
                        </div>
                    </div>             
                </div>
                <br>
                <div class="col-12">
                    ...
                    <table id="datatable-makesales" class="table table-bordered table-striped nowrap data-table-makesales" style="overflow-wrap: anywhere;" width="100%">
                        ...
                        <tbody>
                            @foreach($allGuideline as $key=>$value)
                                <tr>
                                    <td>{{ $value->id }}</td>
                                    <td>{{ $value->title }}</td>
                                    ...
                                    <td style="text-align:center;">
                                        ...
                                        <a class="btn btn-warning btn-sm text-white" href="{{ route('admin.edit_guideline',$value->id) }}">Edit</a>
