            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <a class="btn btn-success float-right text-white" href="{{ route('admin.add_notice') }}">Add New Notice</a>
                        </div>
                    </div>             
                </div>
                <br>
                            ...
                            @foreach($allNotice as $key=>$value)
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        ...
                                        <a class="btn btn-warning btn-sm text-white" href="{{ route('admin.edit_notice',$value->id) }}">Edit</a>
