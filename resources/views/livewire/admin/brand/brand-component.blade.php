<div>
    <!-- Appointments -->
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <a class="btn btn-success float-right text-white" data-toggle="modal" data-target="#modalAddItem">Add New Brand</a>
                        </div>
                    </div>             
                </div>
                <br>
                        ...
                        <tbody>
                            @foreach($allBrands as $key=>$value)
                                <tr>
                                    <td>{{ $value->id }}</td>
                                    <td>
                                        <img src="{{ asset('') }}uploads/brands/{{ $value->image }}" alt="{{ $value->name }}" width="80">
                                    </td>
                                    <td>{{ $value->name }}</td>
                                    <td>
                                        ...
                                        {{-- <a class="btn btn-danger waves-effect waves-light btn-sm" wire:click="deleteID('{{ $value->id }}')" data-toggle="modal" data-target="#modalDeleteCategory">Delete</a> --}}
        ...
        <div wire:ignore.self id="modalAddItem" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form role="form" enctype="multipart/form-data" wire:submit.prevent="storeItem()">
                        @csrf
                        <!--=====================================
                            MODAL HEADER
                        ======================================-->  
                                  ...
                                  <div class="form-group">          
                                    <div class="input-group">             
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        @elseif($e_image)
                                            <img src="{{ asset('uploads/brands') }}/{{ $e_image }}" width="120">
                                        @endif
                                      </div>
                                    </div>
                                  </div>
        ...
        {{-- <!--==========================
          ...
          ===========================-->
        <!-- sample modal content -->
        <div wire:ignore.self id="modalDeleteCategory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
