<div>
    ...
    @push('meta')
        <meta name="description" content="{{ $brand_info->name }}">
        <meta name="keywords" content="{{ $brand_info->meta_tags }}">
    @endpush
                ...
                <section class="py-3 border-bottom d-none d-md-flex">
                    <div class="container">
                        <div class="page-breadcrumb d-flex align-items-center">
                            <h3 class="breadcrumb-title pe-3">Products Of {{ $brand_info->name }} 
                                    {{-- @if($brand_info->verified) 
