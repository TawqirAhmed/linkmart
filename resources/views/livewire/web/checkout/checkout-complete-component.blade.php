                ...
                <div class="container">
                    <div class="card py-3 mt-sm-3">
                        <div class="card-body text-center">
                            ...
                            <p class="fs-sm mb-2">Make sure you make note of your order number, which is <span class="fw-medium">---------.</span>
                            </p>
                            <p class="fs-sm">You will be receiving an email shortly with confirmation of your order. <u>You can now:</u>
                            </p><a class="btn btn-light rounded-0 mt-3 me-3" href="/">Go back shopping</a>
                            {{-- <a class="btn btn-white rounded-0 mt-3" href="order-tracking.html"><i class='bx bx-map'></i>Track order</a> --}}
                        </div>
                    </div>
                </div>
            </section>
