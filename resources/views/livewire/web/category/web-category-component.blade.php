                ...
                <section class="py-3 border-bottom d-none d-md-flex">
                    <div class="container">
                        <div class="page-breadcrumb d-flex align-items-center">
                            <h3 class="breadcrumb-title pe-3">Categories</h3>
                            <div class="ms-auto">
                            ...
                            <div class="row row-cols-1 row-cols-lg-4">
                                ...
                                <div class="col">
                                    <div class="card rounded-0 product-card">
                                        <a href="{{ route('web.single_category',['id'=>$value->id]) }}">
                                            <img src="{{ asset('') }}uploads/categories/{{ $value->name }}/{{ $value->image }}" class="card-img-top border-bottom bg-dark-1" alt="...">
                                        </a>
                                        <div class="list-group list-group-flush">
                                            <a href="{{ route('web.single_category',['id'=>$value->id]) }}" class="list-group-item bg-transparent">
                                                <h6 class="mb-0 text-uppercase">{{ $value->name }}</h6>
                                            </a>    
                                            <a href="{{ route('web.single_category',['id'=>$value->id]) }}" class="list-group-item bg-transparent d-flex justify-content-between align-items-center">
                                            Total Products
