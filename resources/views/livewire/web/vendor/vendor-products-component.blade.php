<div>
    ...
    @push('meta')
        <meta name="description" content="{{ $vendor_info->name }}">
        <meta name="keywords" content="{{ $vendor_info->meta_tags }}">
    @endpush
                ...
                <section class="py-3 border-bottom d-none d-md-flex">
                    <div class="container">
                        <div class="page-breadcrumb d-flex align-items-center">
                            <h3 class="breadcrumb-title pe-3">Products Of {{ $vendor_info->name }} 
                                    @if($vendor_info->verified) 

                                        <img src="{{ asset('') }}assets/images/verified.png" alt="verified">
                                ...
                                <div class="product-wrapper">
                                    ...
                                    <div class="product-grid">
                                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="product-info">
                                                            <a href="{{ route('web.single_category',['id'=>$value->category->id]) }}">
                                                                <p class="product-catergory font-13 mb-1">{{ $value->category->name }}</p>
                                                            </a>
                                                            <a href="{{ route('product_details' ,['id'=>$value->id]) }}">
                                            ...
                                            @else
                                                <h4 class="text-center">Sorry!!! No Product found.</h4>
                                            @endif
