        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a class="btn btn-success float-right" href="{{ route('vendor.add_products' ,['id'=>$vendor_id]) }}">Add Products With Variations</a>
                    </div>

                    <div class="col-2">
                        <a class="btn btn-primary float-right" href="{{ route('vendor.add_products_without_variation' ,['id'=>$vendor_id]) }}">Add Products</a>
                    </div>
                </div>             
            </div>
            <br>
            <div class="col-12">
                ...
                <table id="datatable-makesales" class="table table-bordered table-striped nowrap data-table-makesales" style="overflow-wrap: anywhere;" width="100%">
                    ...
                    <tr>
                        ...
                        <th wire:click="sortBy('vendor_id')">Shop</th>
                        <th>Variations</th>
                    ...
                    <tbody>
                        @foreach($allProducts as $pro=>$pro_all)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('') }}uploads/products/{{ $pro_all->name }}/{{ $pro_all->image }}" width="80px">
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group dropleft">
                                        ...
                                        <a class="btn btn-danger dropdown-item btn" href="{{ route('vendor.edit_products' ,['id'=>$pro_all->id ,'v_id'=>$pro_all->vendors->id]) }}">Edit</a>
