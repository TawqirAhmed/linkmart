...
class Admindashboard extends Component
{
    ...
    public function SetMonthlySale()
    {
        ...
        $temp_amount = array();
        $temp_total_amount = 0;
        $delivered_orders = Order::where('status','delivered')->select(DB::raw('sum(total) as price'),DB::raw('DATE(created_at) as day'))->groupBy('day')->whereBetween('created_at', [Carbon::now()->subMonths(1), Carbon::now()])->get();
    ...
    public function SetYearlySale($this_month)
    {
        ...
        while ($i<$count) {
            ...
            $delivered_orders = Order::where('status','delivered')->select('total',DB::raw('DATE(created_at) as day'))->whereBetween('created_at', [$start, $end])->get();
    ...
    public function SetTopProducts()
    {
        ...
        $orders = Order::where('status','delivered')->select('products')->whereBetween('created_at', [Carbon::now()->subMonths(1), Carbon::now()])->get();
    ...
    public function SetTopProductsLastDay()
    {
        ...
        $orders = Order::where('status','delivered')->select('products')->whereBetween('created_at', [$this->from, $this->to])->get();
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admindashboard',compact('latest_notice'))->layout('admin.adminbase');
    }
}
