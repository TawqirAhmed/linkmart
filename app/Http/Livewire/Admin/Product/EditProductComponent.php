...
class EditProductComponent extends Component
{
    use WithFileUploads;
    //for ptoduct Table
    public $name, $description, $unit, $tags, $image, $images, $warning, $featured, $category_id, $vendor_id, $brand_id, $product_unit_price, $sale_price, $on_sale, $sale_end, $published, $hot_sale, $flash_sale;
    ...
    public function mount($id)
    {
        ...
        $this->flash_sale = $data->flash_sale;
    ...
    public function render()
    {
        ...
        $colors = color::all();
        $brands = Brand::all();
        return view('livewire.admin.product.edit-product-component',compact('categoris','vendors','sizes','colors','brands'))->layout('admin.adminbase');
    }
}
